        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Link href="/professor">
                <Button size="sm" className="gap-2 bg-red-700 hover:bg-red-800 text-white shadow-lg border-0">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <Textarea
                    ...
                    className="min-h-[80px] border-2 border-red-200 focus:border-red-700 focus:ring-red-700/20 focus:ring-4 transition-all duration-300 bg-white text-red-900 placeholder:text-red-600 placeholder:font-medium font-medium"
                  />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select value={materia} onValueChange={setMateria}>
                      <SelectTrigger className="border-2 border-red-200 focus:border-red-700 transition-all duration-300 bg-white text-red-900 font-medium">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      className="border-2 border-red-300 data-[state=checked]:bg-red-700 data-[state=checked]:border-red-700"
                    />
                    <label htmlFor="gabarito" className="text-sm text-red-700 cursor-pointer font-medium">
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-slate-200/50 shadow-xl">
                <CardHeader className="border-b border-slate-200 bg-gradient-to-r from-slate-50 to-slate-100">
                  ...
                  <div className="text-center py-4">
                    ...
                    <div className="w-32 h-1 bg-gradient-to-r from-red-700 to-red-800 mx-auto rounded-full"></div>
                  </div>
                </CardHeader>
