            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Controle de Provedores, Aplicações e Analytics</p>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-5 bg-white border border-slate-200">
            ...
            <TabsTrigger value="providers" className="data-[state=active]:bg-slate-100">Provedores</TabsTrigger>
              ...
              {providers.map((provider) => (
                <Card key={provider.id} className="bg-white/80 backdrop-blur-sm border-slate-200/50">
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <CardTitle className="text-slate-800">{provider.name}</CardTitle>
                          <CardDescription className="text-slate-600">
                            {provider.type === 'bedrock' ? 'AWS Bedrock' : 'LiteLLM Gateway'}
                          </CardDescription>
                        </div>
                      </div>
                      <Badge variant={provider.status === 'active' ? 'default' : 'destructive'}>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div>
                        <h4 className="font-medium text-slate-800 mb-2">Modelos Disponíveis</h4>
                      ...
                      <div className="grid grid-cols-3 gap-4 pt-4 border-t">
                        <div>
                          <p className="text-sm font-medium text-slate-700">Requisições</p>
                          <p className="text-lg font-bold text-slate-900">{provider.usage.requests.toLocaleString()}</p>
                          <p className="text-xs text-slate-500">de {provider.limits.requestsPerDay.toLocaleString()}</p>
                        </div>
                        <div>
                          <p className="text-sm font-medium text-slate-700">Tokens</p>
                          <p className="text-lg font-bold text-slate-900">{(provider.usage.tokens / 1000).toFixed(0)}K</p>
                          <p className="text-xs text-slate-500">de {(provider.limits.tokensPerDay / 1000).toFixed(0)}K</p>
                        </div>
                        <div>
                          <p className="text-sm font-medium text-slate-700">Custo</p>
                          <p className="text-lg font-bold text-slate-900">R$ {provider.usage.cost.toFixed(2)}</p>
                          <p className="text-xs text-slate-500">de R$ {provider.limits.costPerDay.toFixed(2)}</p>
                        </div>
                      </div>
          ...
          <TabsContent value="analytics" className="space-y-6 mt-6">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-3 bg-orange-50 rounded-lg">
                        <p className="text-sm font-medium text-orange-800">Custo Total (30d)</p>
                        <p className="text-2xl font-bold text-orange-900">R$ 15,847</p>
                        <p className="text-xs text-orange-600">+23% vs mês anterior</p>
                      </div>
                      <div className="p-3 bg-orange-50 rounded-lg">
                        <p className="text-sm font-medium text-orange-800">Tokens Processados</p>
                        <p className="text-2xl font-bold text-orange-900">84.2M</p>
                        <p className="text-xs text-orange-600">+18% vs mês anterior</p>
                      </div>
                    </div>
                    
                    <div>
                      <h4 className="font-medium text-slate-800 mb-2">Modelos Mais Utilizados</h4>
                      <div className="space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-slate-600">Claude 3.5 Sonnet</span>
                          <span className="text-sm font-semibold text-slate-900">45%</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-slate-600">Claude 3 Haiku</span>
                          <span className="text-sm font-semibold text-slate-900">32%</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-slate-600">Titan Text</span>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-3 bg-blue-50 rounded-lg">
                        <p className="text-sm font-medium text-blue-800">Custo Total (30d)</p>
                        <p className="text-2xl font-bold text-blue-900">R$ 8,432</p>
                        <p className="text-xs text-blue-600">+15% vs mês anterior</p>
                      </div>
                      <div className="p-3 bg-blue-50 rounded-lg">
                        <p className="text-sm font-medium text-blue-800">Requisições</p>
                        <p className="text-2xl font-bold text-blue-900">267K</p>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-slate-600">GPT-4</span>
                          <span className="text-sm font-semibold text-slate-900">52%</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-slate-600">GPT-3.5-turbo</span>
                          <span className="text-sm font-semibold text-slate-900">31%</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-slate-600">Gemini Pro</span>
                          <span className="text-sm font-semibold text-slate-900">17%</span>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-slate-200/50">
              <CardHeader>
                <CardTitle className="text-slate-800 flex items-center">
                  <BarChart3 className="h-5 w-5 mr-2" />
                  Breakdown de Custos por Aplicação
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {applications.map((app) => (
                    <div key={app.id} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="font-medium text-slate-900">{app.name}</p>
                          <p className="text-xs text-slate-500">{app.currentModel}</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-lg font-bold text-slate-900">R$ {app.usage.dailyCost.toFixed(2)}</p>
                        <p className="text-xs text-slate-500">{app.usage.dailyRequests} req/dia</p>
                      </div>
                    </div>
                  ))}
                </div>
