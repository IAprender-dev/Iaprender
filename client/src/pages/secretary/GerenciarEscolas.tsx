                  ...
                  <TableBody>
                    {filteredEscolas.map((escola) => (
                      <TableRow key={escola.id} className="hover:bg-slate-50">
                        ...
                        <TableCell>
                          <div className="font-semibold text-slate-900">{escola.nomeDiretor || 'Não informado'}</div>
                        </TableCell>
                        <TableCell>
                          <div className="text-sm">
                            <div className="font-semibold text-slate-900">{escola.cidade}, {escola.estado}</div>
                        ...
                        <TableCell>
                          <div className="text-center">
                            <div className="font-semibold text-slate-900">{escola.numeroAlunos || 0}</div>
